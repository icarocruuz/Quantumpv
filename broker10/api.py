...
from broker10.http.login import Login
from broker10.http.loginv2 import Loginv2
from broker10.http.logout import Logout
from broker10.http.login2fa import Login2FA
from broker10.http.send_sms import SMS_Sender
from broker10.http.verify import Verify
from broker10.http.getprofile import Getprofile
from broker10.http.auth import Auth
from broker10.http.token import Token
from broker10.http.appinit import Appinit
from broker10.http.billing import Billing
from broker10.http.buyback import Buyback
from broker10.http.changebalance import Changebalance
from broker10.http.events import Events
from broker10.ws.client import WebsocketClient
from broker10.ws.chanels.get_balances import *

from broker10.ws.chanels.ssid import Ssid
from broker10.ws.chanels.subscribe import *
from broker10.ws.chanels.unsubscribe import *
from broker10.ws.chanels.setactives import SetActives
from broker10.ws.chanels.candles import GetCandles
from broker10.ws.chanels.buyv2 import Buyv2
from broker10.ws.chanels.buyv3 import *
from broker10.ws.chanels.user import *
from broker10.ws.chanels.api_game_betinfo import Game_betinfo
from broker10.ws.chanels.instruments import Get_instruments
from broker10.ws.chanels.get_financial_information import GetFinancialInformation
from broker10.ws.chanels.strike_list import Strike_list
from broker10.ws.chanels.leaderboard import Leader_Board

from broker10.ws.chanels.traders_mood import Traders_mood_subscribe
from broker10.ws.chanels.traders_mood import Traders_mood_unsubscribe
from broker10.ws.chanels.technical_indicators import Technical_indicators
from broker10.ws.chanels.buy_place_order_temp import Buy_place_order_temp
from broker10.ws.chanels.get_order import Get_order
from broker10.ws.chanels.get_deferred_orders import GetDeferredOrders
from broker10.ws.chanels.get_positions import *

from broker10.ws.chanels.get_available_leverages import Get_available_leverages
from broker10.ws.chanels.cancel_order import Cancel_order
from broker10.ws.chanels.close_position import Close_position
from broker10.ws.chanels.get_overnight_fee import Get_overnight_fee
from broker10.ws.chanels.heartbeat import Heartbeat


from broker10.ws.chanels.digital_option import *
from broker10.ws.chanels.api_game_getoptions import *
from broker10.ws.chanels.sell_option import Sell_Option
from broker10.ws.chanels.sell_digital_option import Sell_Digital_Option
from broker10.ws.chanels.change_tpsl import Change_Tpsl
from broker10.ws.chanels.change_auto_margin_call import ChangeAutoMarginCall

from broker10.ws.objects.timesync import TimeSync
from broker10.ws.objects.profile import Profile
from broker10.ws.objects.candles import Candles
from broker10.ws.objects.listinfodata import ListInfoData
from broker10.ws.objects.betinfo import Game_betinfo_data
import broker10.global_value as global_value
...
class broker10(object):  # pylint: disable=too-many-instance-attributes
    ...
    def prepare_http_url(self, resource):
        ...
        :param resource: The instance of
            :class:`Resource <broker10.http.resource.Resource>`.
    ...
    def login_2fa(self):
        ...
        :returns: The instance of :class:`Login2FA
            <broker10.http.login2fa.Login2FA>`.
        """
    ...
    def send_sms_code(self):
        ...
        :returns: The instance of :class:`SMS_Sender
            <broker10.http.send_sms.SMS_Sender>`.
        """
    ...
    def changebalance(self):
        ...
        :returns: The instance of :class:`Changebalance
            <broker10.http.changebalance.Changebalance>`.
        """
    ...
    def getprofile(self):
        ...
        :returns: The instance of :class:`Login
            <broker10.http.getprofile.Getprofile>`.
        """
    ...
    def subscribe(self):
        ...
        :returns: The instance of :class:`Subscribe
            <broker10.ws.chanels.subscribe.Subscribe>`.
        """
    ...
    def unsubscribe(self):
        ...
        :returns: The instance of :class:`Unsubscribe
            <broker10.ws.chanels.unsubscribe.Unsubscribe>`.
        """
    ...
    def setactives(self):
        ...
        :returns: The instance of :class:`SetActives
            <broker10.ws.chanels.setactives.SetActives>`.
        """
    ...
    def getcandles(self):
        ...
        :returns: The instance of :class:`GetCandles
            <broker10.ws.chanels.candles.GetCandles>`.
        """
    ...
    def buy(self):
        ...
        :returns: The instance of :class:`Buyv2
            <broker10.ws.chanels.buyv2.Buyv2>`.
        """
        self.buy_successful = None
        return Buyv2(self)
