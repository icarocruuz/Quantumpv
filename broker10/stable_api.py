# python
from broker10.api import broker10
import broker10.constants as OP_code
import broker10.country_id as Country
import threading
import time
import json
import logging
...
from broker10.expiration import get_expiration_time, get_remaning_time
...
class Broker10:
    ...
    def connect(self, sms_code=None):
        ...
        self.api = broker10(
            "trade.broker10.com", "ws.trade.broker10.com", self.email, self.password
        )
        check = None
        # 2FA--
    ...
    def check_win_v2(self, id_number, polling_time):
        ...
        # Function by kkagill ( https://github.com/Lu-Yi-Hsun/broker10api/issues/196 | https://github.com/kkagill )
    ...
    # thank thiagottjv
    # https://github.com/Lu-Yi-Hsun/broker10api/issues/65#issuecomment-513998357
