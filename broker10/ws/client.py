...
import os
import websocket
from broker10.user_agent import UserAgent
...
class WebsocketClient(object):
    ...
    def __init__(self, api):
        """
        :param api: The instance of :class:`broker10
            <broker10.api.broker10>`.
        """
        self.api = api
        ...
        header = {
            ...
            "Connection": "Upgrade",
            "Host": "ws.trade.broker10.com",
            "Origin": "https://trade.broker10.com",
            "Pragma": "no-cache",
