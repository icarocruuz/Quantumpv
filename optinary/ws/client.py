...
import os
import websocket
from optinary.user_agent import UserAgent
...
class WebsocketClient(object):
    ...
    def __init__(self, api):
        """
        :param api: The instance of :class:`optinary
            <optinary.api.optinary>`.
        """
        self.api = api
        ...
        header = {
            ...
            "Connection": "Upgrade",
            "Host": "ws.trade.optinary.com",
            "Origin": "https://trade.optinary.com",
            "Pragma": "no-cache",
