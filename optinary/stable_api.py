# python
from optinary.api import optinary
import optinary.constants as OP_code
import optinary.country_id as Country
import threading
import time
import json
import logging
...
from optinary.expiration import get_expiration_time, get_remaning_time
...
class OptinarY:
    ...
    def connect(self, sms_code=None):
        ...
        self.api = optinary(
            "trade.optinary.com", "ws.trade.optinary.com", self.email, self.password
        )
        check = None
        # 2FA--
    ...
    def check_win_v2(self, id_number, polling_time):
        ...
        # Function by kkagill ( https://github.com/Lu-Yi-Hsun/optinaryapi/issues/196 | https://github.com/kkagill )
    ...
    # thank thiagottjv
    # https://github.com/Lu-Yi-Hsun/optinaryapi/issues/65#issuecomment-513998357
