...
from optinary.http.login import Login
from optinary.http.loginv2 import Loginv2
from optinary.http.logout import Logout
from optinary.http.login2fa import Login2FA
from optinary.http.send_sms import SMS_Sender
from optinary.http.verify import Verify
from optinary.http.getprofile import Getprofile
from optinary.http.auth import Auth
from optinary.http.token import Token
from optinary.http.appinit import Appinit
from optinary.http.billing import Billing
from optinary.http.buyback import Buyback
from optinary.http.changebalance import Changebalance
from optinary.http.events import Events
from optinary.ws.client import WebsocketClient
from optinary.ws.chanels.get_balances import *

from optinary.ws.chanels.ssid import Ssid
from optinary.ws.chanels.subscribe import *
from optinary.ws.chanels.unsubscribe import *
from optinary.ws.chanels.setactives import SetActives
from optinary.ws.chanels.candles import GetCandles
from optinary.ws.chanels.buyv2 import Buyv2
from optinary.ws.chanels.buyv3 import *
from optinary.ws.chanels.user import *
from optinary.ws.chanels.api_game_betinfo import Game_betinfo
from optinary.ws.chanels.instruments import Get_instruments
from optinary.ws.chanels.get_financial_information import GetFinancialInformation
from optinary.ws.chanels.strike_list import Strike_list
from optinary.ws.chanels.leaderboard import Leader_Board

from optinary.ws.chanels.traders_mood import Traders_mood_subscribe
from optinary.ws.chanels.traders_mood import Traders_mood_unsubscribe
from optinary.ws.chanels.technical_indicators import Technical_indicators
from optinary.ws.chanels.buy_place_order_temp import Buy_place_order_temp
from optinary.ws.chanels.get_order import Get_order
from optinary.ws.chanels.get_deferred_orders import GetDeferredOrders
from optinary.ws.chanels.get_positions import *

from optinary.ws.chanels.get_available_leverages import Get_available_leverages
from optinary.ws.chanels.cancel_order import Cancel_order
from optinary.ws.chanels.close_position import Close_position
from optinary.ws.chanels.get_overnight_fee import Get_overnight_fee
from optinary.ws.chanels.heartbeat import Heartbeat


from optinary.ws.chanels.digital_option import *
from optinary.ws.chanels.api_game_getoptions import *
from optinary.ws.chanels.sell_option import Sell_Option
from optinary.ws.chanels.sell_digital_option import Sell_Digital_Option
from optinary.ws.chanels.change_tpsl import Change_Tpsl
from optinary.ws.chanels.change_auto_margin_call import ChangeAutoMarginCall

from optinary.ws.objects.timesync import TimeSync
from optinary.ws.objects.profile import Profile
from optinary.ws.objects.candles import Candles
from optinary.ws.objects.listinfodata import ListInfoData
from optinary.ws.objects.betinfo import Game_betinfo_data
import optinary.global_value as global_value
...
class optinary(object):  # pylint: disable=too-many-instance-attributes
    ...
    def prepare_http_url(self, resource):
        ...
        :param resource: The instance of
            :class:`Resource <optinary.http.resource.Resource>`.
    ...
    def login_2fa(self):
        ...
        :returns: The instance of :class:`Login2FA
            <optinary.http.login2fa.Login2FA>`.
        """
    ...
    def send_sms_code(self):
        ...
        :returns: The instance of :class:`SMS_Sender
            <optinary.http.send_sms.SMS_Sender>`.
        """
    ...
    def changebalance(self):
        ...
        :returns: The instance of :class:`Changebalance
            <optinary.http.changebalance.Changebalance>`.
        """
    ...
    def getprofile(self):
        ...
        :returns: The instance of :class:`Login
            <optinary.http.getprofile.Getprofile>`.
        """
    ...
    def subscribe(self):
        ...
        :returns: The instance of :class:`Subscribe
            <optinary.ws.chanels.subscribe.Subscribe>`.
        """
    ...
    def unsubscribe(self):
        ...
        :returns: The instance of :class:`Unsubscribe
            <optinary.ws.chanels.unsubscribe.Unsubscribe>`.
        """
    ...
    def setactives(self):
        ...
        :returns: The instance of :class:`SetActives
            <optinary.ws.chanels.setactives.SetActives>`.
        """
    ...
    def getcandles(self):
        ...
        :returns: The instance of :class:`GetCandles
            <optinary.ws.chanels.candles.GetCandles>`.
        """
    ...
    def buy(self):
        ...
        :returns: The instance of :class:`Buyv2
            <optinary.ws.chanels.buyv2.Buyv2>`.
        """
        self.buy_successful = None
        return Buyv2(self)
