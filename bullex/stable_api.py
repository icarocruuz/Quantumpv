# python
from bullex.api import bullex
import bullex.constants as OP_code
import bullex.country_id as Country
import threading
import time
import json
import logging
...
from bullex.expiration import get_expiration_time, get_remaning_time
...
class BulleX:
    ...
    def connect(self, sms_code=None):
        ...
        self.api = bullex(
            "trade.bull-ex.com", "ws.trade.bull-ex.com", self.email, self.password
        )
        check = None
        # 2FA--
