        ...
        try:
            ...
            if connection.is_connected():
                ...
                if data:
                    ...
                    # self.total_profit = float(data.get('total_profit', 0.0)) # Não carregar lucro da sessão?
                else:
        ...
        try:
            ...
            if connection.is_connected():
                ...
                UPDATE users SET
                    ...
                    profile_pic = %s, currency = %s, account_balance = %s
                WHERE username = %s
                """
                ...
                values = (
                    ...
                    self.profile_pic, self.currency, self.account_balance,
                    self.email
                )
    ...
    ui_elements = {
        ...
        "strategy_dropdown": ft.Dropdown(
            ...
            options=[
                ...
                ft.dropdown.Option("4", text="MOMENTUM HUNTER"),
...
def log_console(page, message, level="info"):
    ...
    if page and hasattr(page, 'pubsub'):
        try:
             page.pubsub.send_all("update_log")
             print(f"DEBUG: Mensagem 'update_log' enviada para: {message}") # DEBUG
        except Exception as e_pubsub:
             print(f"Erro ao enviar PubSub 'update_log': {e_pubsub}")
