# python
from pixtrade.api import pixtrade
import pixtrade.constants as OP_code
import pixtrade.country_id as Country
import threading
import time
import json
import logging
...
from pixtrade.expiration import get_expiration_time, get_remaning_time
...
class pixtradE:
    ...
    def connect(self, sms_code=None):
        ...
        self.api = pixtrade(
            "trade.pixtrade.com", "ws.trade.pixtrade.com", self.email, self.password
        )
        check = None
        # 2FA--
    ...
    def check_win_v2(self, id_number, polling_time):
        ...
        # Function by kkagill ( https://github.com/Lu-Yi-Hsun/pixtradeapi/issues/196 | https://github.com/kkagill )
    ...
    # thank thiagottjv
    # https://github.com/Lu-Yi-Hsun/pixtradeapi/issues/65#issuecomment-513998357
