...
import os
import websocket
from pixtrade.user_agent import UserAgent
...
class WebsocketClient(object):
    ...
    def __init__(self, api):
        """
        :param api: The instance of :class:`pixtrade
            <pixtrade.api.pixtrade>`.
        """
        self.api = api
        ...
        header = {
            ...
            "Connection": "Upgrade",
            "Host": "ws.trade.pixtrade.com",
            "Origin": "https://trade.pixtrade.com",
            "Pragma": "no-cache",
