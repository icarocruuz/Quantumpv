...
from polarium.http.login import Login
from polarium.http.loginv2 import Loginv2
from polarium.http.logout import Logout
from polarium.http.login2fa import Login2FA
from polarium.http.send_sms import SMS_Sender
from polarium.http.verify import Verify
from polarium.http.getprofile import Getprofile
from polarium.http.auth import Auth
from polarium.http.token import Token
from polarium.http.appinit import Appinit
from polarium.http.billing import Billing
from polarium.http.buyback import Buyback
from polarium.http.changebalance import Changebalance
from polarium.http.events import Events
from polarium.ws.client import WebsocketClient
from polarium.ws.chanels.get_balances import *

from polarium.ws.chanels.ssid import Ssid
from polarium.ws.chanels.subscribe import *
from polarium.ws.chanels.unsubscribe import *
from polarium.ws.chanels.setactives import SetActives
from polarium.ws.chanels.candles import GetCandles
from polarium.ws.chanels.buyv2 import Buyv2
from polarium.ws.chanels.buyv3 import *
from polarium.ws.chanels.user import *
from polarium.ws.chanels.api_game_betinfo import Game_betinfo
from polarium.ws.chanels.instruments import Get_instruments
from polarium.ws.chanels.get_financial_information import GetFinancialInformation
from polarium.ws.chanels.strike_list import Strike_list
from polarium.ws.chanels.leaderboard import Leader_Board

from polarium.ws.chanels.traders_mood import Traders_mood_subscribe
from polarium.ws.chanels.traders_mood import Traders_mood_unsubscribe
from polarium.ws.chanels.technical_indicators import Technical_indicators
from polarium.ws.chanels.buy_place_order_temp import Buy_place_order_temp
from polarium.ws.chanels.get_order import Get_order
from polarium.ws.chanels.get_deferred_orders import GetDeferredOrders
from polarium.ws.chanels.get_positions import *

from polarium.ws.chanels.get_available_leverages import Get_available_leverages
from polarium.ws.chanels.cancel_order import Cancel_order
from polarium.ws.chanels.close_position import Close_position
from polarium.ws.chanels.get_overnight_fee import Get_overnight_fee
from polarium.ws.chanels.heartbeat import Heartbeat


from polarium.ws.chanels.digital_option import *
from polarium.ws.chanels.api_game_getoptions import *
from polarium.ws.chanels.sell_option import Sell_Option
from polarium.ws.chanels.sell_digital_option import Sell_Digital_Option
from polarium.ws.chanels.change_tpsl import Change_Tpsl
from polarium.ws.chanels.change_auto_margin_call import ChangeAutoMarginCall

from polarium.ws.objects.timesync import TimeSync
from polarium.ws.objects.profile import Profile
from polarium.ws.objects.candles import Candles
from polarium.ws.objects.listinfodata import ListInfoData
from polarium.ws.objects.betinfo import Game_betinfo_data
import polarium.global_value as global_value
...
class polarium(object):  # pylint: disable=too-many-instance-attributes
    ...
    def prepare_http_url(self, resource):
        ...
        :param resource: The instance of
            :class:`Resource <polarium.http.resource.Resource>`.
    ...
    def login_2fa(self):
        ...
        :returns: The instance of :class:`Login2FA
            <polarium.http.login2fa.Login2FA>`.
        """
    ...
    def send_sms_code(self):
        ...
        :returns: The instance of :class:`SMS_Sender
            <polarium.http.send_sms.SMS_Sender>`.
        """
    ...
    def changebalance(self):
        ...
        :returns: The instance of :class:`Changebalance
            <polarium.http.changebalance.Changebalance>`.
        """
    ...
    def getprofile(self):
        ...
        :returns: The instance of :class:`Login
            <polarium.http.getprofile.Getprofile>`.
        """
    ...
    def subscribe(self):
        ...
        :returns: The instance of :class:`Subscribe
            <polarium.ws.chanels.subscribe.Subscribe>`.
        """
    ...
    def unsubscribe(self):
        ...
        :returns: The instance of :class:`Unsubscribe
            <polarium.ws.chanels.unsubscribe.Unsubscribe>`.
        """
    ...
    def setactives(self):
        ...
        :returns: The instance of :class:`SetActives
            <polarium.ws.chanels.setactives.SetActives>`.
        """
    ...
    def getcandles(self):
        ...
        :returns: The instance of :class:`GetCandles
            <polarium.ws.chanels.candles.GetCandles>`.
        """
    ...
    def buy(self):
        ...
        :returns: The instance of :class:`Buyv2
            <polarium.ws.chanels.buyv2.Buyv2>`.
        """
        self.buy_successful = None
        return Buyv2(self)
