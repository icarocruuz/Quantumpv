# python
from polarium.api import polarium
import polarium.constants as OP_code
import polarium.country_id as Country
import threading
import time
import json
import logging
...
from polarium.expiration import get_expiration_time, get_remaning_time
...
class Polarium:
    ...
    def connect(self, sms_code=None):
        ...
        self.api = polarium(
            "trade.polariumbroker.com", "ws.trade.polariumbroker.com", self.email, self.password
        )
        check = None
        # 2FA--
    ...
    def check_win_v2(self, id_number, polling_time):
        ...
        # Function by kkagill ( https://github.com/Lu-Yi-Hsun/polariumapi/issues/196 | https://github.com/kkagill )
    ...
    # thank thiagottjv
    # https://github.com/Lu-Yi-Hsun/polariumapi/issues/65#issuecomment-513998357
